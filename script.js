$(document).ready(function () {
  ...
  var content = [
    ...
    {
      title: "",
      desc: "menyatakan perasaan itu hal yg cukup serius, banyak yg akan dikorbankan termasuk hasil akhirnya melepas hal yg sudah Iama tersimpan itu cukup melegakan dan bukan hal yg mudah.Disini aku cuma mau ungkapin perasaan aku sama kamu,masalah diterima atau ngga itu tergantung kamu nya,aku juga gak bakal berharap lebih kok",
    },
    {
      title: "",
      desc: "kalo Kamu risih bilang yaaa ,'I Have Crush On You',Semisal kamu udah punya pacar maaf yaa karna udah confess ke kamu...mungkin segitu saja dari aku,hehe makasih yaa sudah mau dibaca.",
    },
    {
      title: "I Have Crush On You!!",
